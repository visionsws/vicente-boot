package com.vicente.vicenteboot.common.snowflake;

import com.vicente.vicenteboot.util.DateUtil;
...
public class SnowflakeIdWorker {
	...
	public Map parseInfo(String id) {
        ...
        String date = DateUtil.timestampToDate(timeLong);
        map.put("date", date);
        return map;
    }
	...
	public static void main(String[] args) {
        ...
        System.out.println(JacksonUtil.writeValueAsString(json));
    }
}